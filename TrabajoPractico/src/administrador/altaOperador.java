...
public class altaOperador extends JFrame {

	private JPanel contentPane;
	private JTextField txtNombre;
	private static altaOperador altaOperador;
	...
	public altaOperador() {
		...
		btnAltaTecnico.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				operador = Controlador.crearOperador(txtNombre.getText().toString(),
				...
				if (operador.getDni() != -1 && operador.getUsuario() != "-1") {
					p = new popUp("OPERADOR CON DNI: " + operador.getDni() + " Y USUARIO: "
							+ operador.getUsuario() + " CREADO CON EXITO");
					txtNombre.setText("");
					txtApellido.setText("");
					txtDNI.setText("");
				...
				} else if (operador.getDni() == -1 && operador.getUsuario() == "-1")
					p = new popUp("YA EXISTE UN OPERADOR CON EL DNI: " + txtDNI.getText().toString() + " Y USUARIO: "
							+ txtUsuario.getText().toString());
				else if (operador.getDni() == -1)
					p = new popUp("YA EXISTE UN OPERADOR CON EL DNI: " + txtDNI.getText().toString());
				else
					p = new popUp("YA EXISTE EL USUARIO: " + txtUsuario.getText().toString());

				p.setLocationRelativeTo(altaOperador);
				p.setVisible(true);

				Controlador.listarOperadores();
